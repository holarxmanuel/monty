 ...
 *
 * Description: Frees all nodes in the stack_t linked list.
 */
 ...
 *         Otherwise - 2.
 *
 * Description: Determines the current mode (stack or queue) of the stack_t.
 */
 ...
 *
 * Description: Creates a new stack_t structure and sets it to STACK mode.
 */
